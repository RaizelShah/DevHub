        ...
        <ScrollView className="flex-1 bg-background">
            <View className="flex-1 bg-background">
                <View className="flex justify-center items-center h-[250px]">
                    <Text className="text-2xl text-textPrimary justify-center">
                        New Here?
                    </Text>
                    <Text className="text-xl text-textPrimary justify-center">
                ...
                <View className="p-5">
                    ...
                    >
                        ...
                        <Text className="text-textSecondary">Log In</Text>
                    </Link>
                </View>
                <ReactNativeModal
